...
{
    public class BusBoardingSystemAuthorizationProvider : AuthorizationProvider
    {
        ...
        {
            return new LocalizableString(name, BusBoardingSystemConsts.LocalizationSourceName);
        }
    }
}
