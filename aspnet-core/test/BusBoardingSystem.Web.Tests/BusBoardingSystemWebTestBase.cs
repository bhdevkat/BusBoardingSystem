...
{
    public abstract class BusBoardingSystemWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static BusBoardingSystemWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(BusBoardingSystemWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<BusBoardingSystemDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<BusBoardingSystemDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<BusBoardingSystemDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<BusBoardingSystemDbContext, Task<T>> func)
        {
            T result;
